...
class DataStreamManager:
    ...
    def add_connector(self, 
        ...
        self.logger.info("Added connector", 
                        name=name, 
        ...
        try:
            ...
            for name, connector in self.connectors.items():
                ...
                if success:
                    ...
                    task = asyncio.create_task(self._stream_from_connector(name, connector))
    ...
    async def stop(self) -> None:
        ...
        self.logger.info("Data stream manager stopped", 
                        uptime=uptime,
                        messages_processed=self.stats["messages_processed"])
    
    async def _stream_from_connector(self, name: str, connector: BaseFXConnector) -> None:
            ...
            async for market_data in connector.stream():
                ...
                try:
                    ...
                    if self.stats["messages_processed"] % 100 == 0:
                        self.logger.debug("Messages processed", 
...
async def create_mock_data_stream(symbols: List[str] = None, 
                                publisher_address: str = "tcp://*:5555") -> DataStreamManager:
    """
