...
class ComponentFailureSimulator:
    ...
    def simulate_api_failure(self, component: str, duration_seconds: int = 45):
        ...
        self.logger.warning(f"Simulating {component} API failure for {duration_seconds}s")
...
class StressTestRunner:
    ...
    async def run_all_stress_tests(self) -> Dict[str, Any]:
        ...
        passed_tests = sum(1 for result in self.test_results.values() if result['success'] > 0)
