...
from services.execution.fix_connector.fix_message_utils import (
    FIXMessageUtils, FIXMessage, FIXVersion, parse_fix_message, build_fix_message
)
from services.execution.fix_connector.fix_client import (
    FIXClient, FIXSessionConfig, FIXSessionState, load_fix_config
)
from services.execution.fix_connector.fix_order_router import (
    FIXOrderRouter, FIXOrderMapping, FIXExecutionReport, create_fix_order_router
)
...
class TestFIXMessageUtils:
    ...
    def test_checksum_validation(self):
        ...
        valid_message_corrected = message_without_checksum + f"10={correct_checksum:03d}\x01"
...
class TestFIXOrderRouter:
    ...
    def setup_method(self):
        ...
        with patch('services.execution.fix_connector.fix_order_router.load_fix_config') as mock_load:
    ...
    def test_fix_status_conversion(self):
        ...
        assert self.router._convert_fix_status_to_internal("1") == OrderStatus.PARTIALLY_FILLED
...
class TestFIXErrorHandling:
    ...
    def test_sequence_number_handling(self):
        ...
        client = FIXClient(FIXSessionConfig(
            host="127.0.0.1",
            port=4002,
            sender_comp_id="TEST",
            target_comp_id="IB"
