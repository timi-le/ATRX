...
class TestSimpleSentimentAnalyzer:
    ...
    async def test_negative_sentiment(self, sentiment_analyzer):
        ...
        text = (
            "The economy is in decline with weak performance and disappointing results."
        )
...
class TestMacroEngineIntegration:
    ...
    async def test_end_to_end_workflow(self):
        ...
        try:
            ...
            assert (
                vector2.currency_surprises[Currency.USD]
                != vector1.currency_surprises[Currency.USD]
            )
...
class TestMacroEngineFactory:
    ...
    def test_create_macro_engine_custom_params(self):
        ...
        engine = create_macro_engine(
            use_mock_data=True, surprise_window=100, sentiment_window=15, logger=logger
        )
