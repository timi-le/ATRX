...
from data.dukascopy_connector import DukascopyConfig, DukascopyConnector
...
class TestDukascopyConfig:
    ...
    def test_config_initialization(self):
        ...
        config = DukascopyConfig(symbols=["EUR/USD", "GBP/USD"], timeout=30)
    ...
    def test_config_custom_settings(self):
        ...
        config = DukascopyConfig(
            symbols=["EUR/USD"], max_concurrent_downloads=10, user_agent="Custom Agent"
        )
...
class TestDukascopyConnector:
    ...
    def dukascopy_config(self):
        ...
        return DukascopyConfig(symbols=["EUR/USD", "GBP/USD"], timeout=10)
