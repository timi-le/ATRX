...
from data.oanda_connector import OandaConnector, OandaConfig
...
class TestOandaConnector:
        ...
        candles_response = {
            "candles": [
                ...
                },
                {
                    ...
                    "mid": {"o": "1.08420", "h": "1.08470", "l": "1.08400", "c": "1.08460"},
                    "volume": 1200,
                    "complete": True
                }
            ]
    ...
    def test_convert_timeframe(self, oanda_connector):
        ...
        assert oanda_connector._convert_timeframe("M1") == "M1"  # Already in OANDA format
