...
class TestParameterTuner(unittest.TestCase):
    ...
    def test_set_parameter_valid(self):
        ...
        self.assertEqual(self.tuner.get_parameter("strategy_parameters.grid_step_factor"), 0.8)
        ...
        result = self.tuner.set_parameter("strategy_parameters.session_filter_enabled", False)
        self.assertTrue(result)
        self.assertEqual(self.tuner.get_parameter("strategy_parameters.session_filter_enabled"), False)
        
        # Test string parameter
        result = self.tuner.set_parameter("strategy_parameters.tp_type", "fixed")
        self.assertTrue(result)
        self.assertEqual(self.tuner.get_parameter("strategy_parameters.tp_type"), "fixed")
    ...
    def test_set_parameter_invalid(self):
        ...
        with self.assertRaises(ParameterValidationError):
            self.tuner.set_parameter("strategy_parameters.grid_step_factor", 5.0)  # Max is 2.0
    ...
    def test_parameter_validation(self):
        ...
        self.tuner._validate_parameter("session_filter_enabled", "true")  # String to bool
    ...
    def test_config_save_and_load(self):
        ...
        self.assertEqual(new_tuner.get_parameter("strategy_parameters.grid_step_factor"), 0.8)
    ...
    def test_version_management(self):
        ...
        if versions:
            ...
            self.assertEqual(self.tuner.get_parameter("strategy_parameters.grid_step_factor"), 1.5)
            ...
            # Verify restoration
            restored_value = self.tuner.get_parameter("strategy_parameters.grid_step_factor")
    ...
    def test_validate_all_parameters(self):
        ...
        self.tuner.set_parameter("strategy_parameters.grid_step_factor", 10.0, validate=False)
        results = self.tuner.validate_all_parameters()
...
class TestParameterTunerCLI(unittest.TestCase):
    ...
    def test_cli_set_parameter(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            ...
            '--set', 'strategy_parameters.grid_step_factor=0.8',
            '--set', 'strategy_parameters.max_levels=7'
        ]
        ...
        self.assertEqual(tuner.get_parameter("strategy_parameters.grid_step_factor"), 0.8)
    ...
    def test_cli_get_parameter(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'parameter_tuner.py',
            '--config', str(self.config_path),
            '--get', 'strategy_parameters.grid_step_factor'
        ]
    ...
    def test_cli_validation_error(self, mock_argv):
        ...
        mock_argv.__getitem__.side_effect = [
            'parameter_tuner.py',
            '--config', str(self.config_path),
            '--set', 'strategy_parameters.grid_step_factor=10.0'  # Invalid value
        ]
...
if __name__ == "__main__":
    ...
    test_suite.addTest(unittest.makeSuite(TestParameterTunerCLI))
    test_suite.addTest(unittest.makeSuite(TestParameterValidation))
