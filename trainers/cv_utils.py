        ...
        for param_combo in param_combinations:
            ...
            for fold, (train_idx, test_idx) in enumerate(self.split(X, y)):
                ...
                if scoring == 'mse':
                    ...
                    train_score = accuracy_score(y_train, (y_train_pred > 0.5).astype(int))
            ...
            is_better = (
                (scoring in ['mse', 'mae'] and mean_cv_score < best_score) or
...
def validate_cv_setup(
    ...
    try:
        ...
        for i, (train_idx, test_idx) in enumerate(splits):
            ...
            if hasattr(cv_method, 'gap') or isinstance(cv_method, (TimeSeriesKFold, PurgedKFold)):
