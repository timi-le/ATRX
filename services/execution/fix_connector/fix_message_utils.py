...
class FIXMessageUtils:
    ...
    STANDARD_FIELDS = {
        ...
        141: FIXField(141, "ResetSeqNumFlag", False, "BOOLEAN", "Reset sequence number flag"),
    ...
    def build_message(
        self,
        msg_type: str,
        fields: Dict[int, Union[str, int, float]],
        sender_comp_id: str,
        target_comp_id: str,
        sequence_number: int,
        ...
        try:
            ...
            remaining_tags = sorted([tag for tag in message_fields.keys() 
...
def parse_fix_message(raw_message: str, fix_version: FIXVersion = FIXVersion.FIX_4_2) -> FIXMessage:
    """Parse a FIX message."""
...
def build_fix_message(
    ...
    """Build a FIX message."""
    utils = FIXMessageUtils(fix_version)
    return utils.build_message(msg_type, fields, sender_comp_id, target_comp_id, sequence_number) 