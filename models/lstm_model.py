...
class LSTMPredictor(BasePredictorModel):
    ...
    def __init__(
        ...
        self.use_bidirectional = getattr(
    ...
    def build_model(self) -> "keras.Model":
        ...
        if self.use_attention:
            attention = layers.MultiHeadAttention(
                num_heads=4, key_dim=self.lstm_units // 4, name="attention"
            )
            x = attention(x, x)
        ...
        optimizer = optimizers.Adam(
            ...
            * 2,  # Higher LR for faster convergence
            beta_1=0.9,
            beta_2=0.999,
            epsilon=1e-7,
...
def create_lstm_config(
    ...
    **kwargs,
    ...
    config.use_bidirectional = kwargs.get(
