...
from core.regime_detector import RegimeType, RegimeOutput, RegimeFeatures
...
class StrategyDecision:
    ...
    ml_prediction_used: Optional[Prediction]
    decision_time_ms: float
    ensemble_signals: Optional[Dict[str, Signal]] = None
...
class StrategySwitcher:
    ...
    def __init__(
        self, 
        config: Optional[StrategySwitcherConfig] = None,
    ...
    async def choose_strategy(
        ...
        try:
            ...
            if regime.confidence < self.config.confidence_threshold:
                ...
                return self._create_no_signal_decision(regime, ml_prediction, decision_time_ms)
    ...
    def _apply_ml_weighting(
        ...
        if ml_side != signal.side:
             ...
             self.logger.warning("ML signal conflicts with strategy signal.", ml_signal=ml_side.value, strategy_signal=signal.side.value)
             return signal
    ...
    def _blend_ensemble_signals(
        ...
        final_side = OrderSide.BUY if signal_votes["BUY"] > signal_votes["SELL"] else OrderSide.SELL
    ...
    def _calculate_ensemble_confidence(
        ...
        # Combined confidence
        ensemble_confidence = (agreement * 0.4 + avg_confidence * 0.4 + regime_confidence * 0.2)
    ...
    def get_performance_metrics(self) -> Dict[str, float]:
        ...
        return {
            ...
            "last_decision_time_ms": self.last_decision.decision_time_ms if self.last_decision else 0.0
        }
